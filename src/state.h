...
namespace state {
  ...
  public:
    ...
    void activate (state::Boards attackingBoard, Boards* defendingBoard, int index);
    void desactivate (state::Boards attackingBoard, Boards* defendingBoard);
  };
  ...
  public:
    void activate (state::Boards attackingBoard, Boards* defendingBoard, int index);
    void desactivate (state::Boards attackingBoard, Boards* defendingBoard, int index);
  };
  ...
  class TrapCounter : public Traps {
    // Operations
  public:
    void activate (state::Boards attackingBoard, state::Boards defendingBoard, int index);
    void desactivate (state::Boards attackingBoard, Boards* defendingBoard, int index);
  };
